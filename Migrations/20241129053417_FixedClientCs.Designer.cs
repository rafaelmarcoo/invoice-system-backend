...
namespace invoice_system_backend.Migrations
{
    ...
    [Migration("20241129053417_FixedClientCs")]
    partial class FixedClientCs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("invoice_system_backend.Models.Invoice", b =>
                {
                    ...
                    b.Property<string>("clientCompanyCode")
                        .HasColumnType("text");

                    b.HasKey("Id");

                    b.HasIndex("clientCompanyCode");
            ...
            modelBuilder.Entity("invoice_system_backend.Models.Invoice", b =>
                {
                    b.HasOne("invoice_system_backend.Models.Client", "client")
                        .WithMany("Invoices")
                        .HasForeignKey("clientCompanyCode");
